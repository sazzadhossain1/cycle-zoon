...
const Footer = () => {
  return (
    <div className="footer-main-parent-div">
      <h1>This is footer @ 2023</h1>
      <div>
        <h3>ABOUT Cycle ZzOoN</h3>
        <div></div>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione quos
          dolorem qui distinctio rem nihil optio repudiandae deserunt, corrupti
          incidunt, omnis architecto blanditiis doloremque temporibus,
          consectetur velit eius impedit sunt.
        </p>
        <div>
